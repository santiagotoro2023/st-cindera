<div class="" id="content">
   <section data-section-id="4" data-share="" data-category="page-examples" data-component-id="32ccd88f_02_awz" class="py-3">
            ...
            <div class="flex flex-wrap -mx-3 -mb-6">
                  ...
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        <div class="flex mx-auto w-12 h-12 mb-4 items-center justify-center bg-blue-500 bg-opacity-20 text-blue-500 rounded-xl">
                           <svg width="22" height="22" viewbox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-1-2">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-1-2">Budget</span>
                        <h4 class="text-2xl leading-8 text-gray-100 font-semibold mb-4" data-config-id="auto-txt-2-2">$28K</h4>
                        <div class="flex flex-wrap items-center justify-center -m-1">
                           <div class="w-auto p-1">
                              <span class="inline-block py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full" data-config-id="auto-txt-3-2">1,0%</span>
                           </div>
                           <div class="w-auto p-1">
                              <span class="text-xs text-gray-300 font-medium" data-config-id="auto-txt-4-2">Since last month</span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        <div class="flex mx-auto w-12 h-12 mb-4 items-center justify-center bg-blue-500 bg-opacity-20 text-blue-500 rounded-xl">
                           <svg width="22" height="18" viewbox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-2-2">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-5-2">Total customers</span>
                        <h4 class="text-2xl leading-8 text-gray-100 font-semibold mb-4" data-config-id="auto-txt-6-2">1.6K</h4>
                        <div class="flex flex-wrap items-center justify-center -m-1">
                           <div class="w-auto p-1">
                              <span class="inline-block py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full" data-config-id="auto-txt-7-2">1,0%</span>
                           </div>
                           <div class="w-auto p-1">
                              <span class="text-xs text-gray-300 font-medium" data-config-id="auto-txt-8-2">Since last month</span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        <div class="flex mx-auto w-12 h-12 mb-4 items-center justify-center bg-blue-500 bg-opacity-20 text-blue-500 rounded-xl">
                           <svg width="16" height="20" viewbox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-3-2">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-9-2">Tasks Progress</span>
                        <h4 class="text-2xl leading-8 text-gray-100 font-semibold mb-4" data-config-id="auto-txt-10-2">64.5%</h4>
                        <div class="flex flex-wrap items-center justify-center -m-1">
                           <div class="w-auto p-1">
                              <span class="inline-block py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full" data-config-id="auto-txt-11-2">1,0%</span>
                           </div>
                           <div class="w-auto p-1">
                              <span class="text-xs text-gray-300 font-medium" data-config-id="auto-txt-12-2">Since last month</span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        <div class="flex mx-auto w-12 h-12 mb-4 items-center justify-center bg-blue-500 bg-opacity-20 text-blue-500 rounded-xl">
                           <svg width="22" height="22" viewbox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-4-2">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-13-2">Total profit</span>
                        <h4 class="text-2xl leading-8 text-gray-100 font-semibold mb-4" data-config-id="auto-txt-14-2">$23K</h4>
                        <div class="flex flex-wrap items-center justify-center -m-1">
                           <div class="w-auto p-1">
                              <span class="inline-block py-1 px-2 text-xs text-green-500 font-medium bg-teal-900 rounded-full" data-config-id="auto-txt-15-2">1,0%</span>
                           </div>
                           <div class="w-auto p-1">
                              <span class="text-xs text-gray-300 font-medium" data-config-id="auto-txt-16-2">Since last month</span>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="mb-6">
            <div class="flex flex-wrap -mx-3">
                  ...
                  <div class="p-6 bg-gray-500 rounded-xl">
                     <div class="flex flex-wrap -mx-4 -mb-4 justify-between items-center">
                        <div class="w-auto px-4 mb-4">
                           <h4 class="text-gray-100 font-bold tracking-wide" data-config-id="auto-txt-17-2">Latest Sales</h4>
                        </div>
                        <div class="w-auto px-4 mb-4">
                           <div class="flex items-center">
                              <div class="mr-4">
                                 <span class="inline-block w-2 h-2 mr-1 bg-blue-500 rounded-full"></span>
                                 <span class="text-xs text-gray-300" data-config-id="auto-txt-18-2">This year</span>
                              </div>
                              <div class="mr-6">
                                 <span class="inline-block w-2 h-2 mr-1 bg-purple-500 rounded-full"></span>
                                 <span class="text-xs text-gray-300" data-config-id="auto-txt-19-2">Last year</span>
                              </div>
                              <div class="relative inline-block bg-gray-600 rounded-xl">
                                 <select class="relative py-3 pl-2 pr-6 cursor-pointer bg-transparent text-xs text-gray-300 font-semibold appearance-none outline-none" style="z-index: 1;" name="" id="" data-config-id="auto-input-13-2">
                                    <option value="" data-config-id="txt-7eacab-1">Last 7 days</option>
                                    <option value="" data-config-id="txt-7eacab-2">Last Month</option>
                                 </select>
                                 <span class="absolute top-1/2 right-0 mr-2 transform -translate-y-1/2" style="z-index: 0;">
                                    <svg width="10" height="7" viewbox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-5-2">
               ...
               <div class="w-full lg:w-1/3 px-3">
                  <div class="p-6 bg-gray-500 rounded-xl">
                     <h4 class="text-gray-100 font-bold tracking-wide mb-8" data-config-id="auto-txt-20-2">Traffic by Device</h4>
                     ...
                     <div class="flex flex-wrap px-4 items-center justify-between">
                        <div class="text-center">
                           ...
                           <h6 class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-21-2">Desktop</h6>
                           <h5 class="text-2xl text-gray-100 font-semibold" data-config-id="auto-txt-22-2">65%</h5>
                        </div>
                        <div class="text-center">
                           <span class="inline-block w-2 h-2 mb-2 bg-purple-500 rounded-full"></span>
                           <h6 class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-23-2">Mobile</h6>
                           <h5 class="text-2xl text-gray-100 font-semibold" data-config-id="auto-txt-24-2">20%</h5>
                        </div>
                        <div class="text-center">
                           <span class="inline-block w-2 h-2 mb-2 bg-yellow-500 rounded-full"></span>
                           <h6 class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-25-2">Tablet</h6>
                           <h5 class="text-2xl text-gray-100 font-semibold" data-config-id="auto-txt-26-2">15%</h5>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="flex flex-wrap -mx-3">
            <div class="w-full lg:w-1/3 px-3 mb-6 lg:mb-0">
               <div class="h-full py-6 px-4 sm:px-6 bg-gray-500 rounded-xl">
                  <h4 class="text-lg text-gray-100 font-semibold mb-6" data-config-id="auto-txt-27-2">Latest Products</h4>
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        <div class="flex w-10 h-10 mr-3 items-center justify-center bg-gray-400 bg-opacity-20 text-blue-500 rounded-xl">
                           <img src="trizzle-assets/logos/dropbox.svg" alt="" data-config-id="auto-img-1-2">
                        </div>
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-28-2">Dropbox</h5>
                           <p class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-29-2">Updated about 7 hours</p>
                        </div>
                     </div>
                     <svg width="4" height="18" viewbox="0 0 4 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-6-2">
                  ...
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        <div class="flex w-10 h-10 mr-3 items-center justify-center bg-gray-400 bg-opacity-20 text-blue-500 rounded-xl">
                           <img src="trizzle-assets/logos/medium.svg" alt="" data-config-id="auto-img-2-2">
                        </div>
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-30-2">Medium</h5>
                           <p class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-31-2">Updated about 7 hours</p>
                        </div>
                     </div>
                     <svg width="4" height="18" viewbox="0 0 4 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-7-2">
                        <path d="M2 4C2.39556 4 2.78224 3.8827 3.11114 3.66294C3.44004 3.44318 3.69639 3.13082 3.84776 2.76537C3.99914 2.39992 4.03874 1.99778 3.96157 1.60982C3.8844 1.22186 3.69392 0.865492 3.41421 0.585787C3.13451 0.306082 2.77814 0.115601 2.39018 0.0384303C2.00222 -0.0387401 1.60009 0.000866562 1.23463 0.152242C0.869182 0.303617 0.556825 0.559962 0.337062 0.88886C0.117299 1.21776 1.07779e-06 1.60444 1.07779e-06 2C1.07779e-06 2.53043 0.210715 3.03914 0.585788 3.41421C0.960861 3.78929 1.46957 4 2 4ZM2 14C1.60444 14 1.21776 14.1173 0.888861 14.3371C0.559963 14.5568 0.303617 14.8692 0.152242 15.2346C0.000866562 15.6001 -0.0387401 16.0022 0.0384303 16.3902C0.115601 16.7781 0.306083 17.1345 0.585788 17.4142C0.865493 17.6939 1.22186 17.8844 1.60982 17.9616C1.99778 18.0387 2.39992 17.9991 2.76537 17.8478C3.13082 17.6964 3.44318 17.44 3.66294 17.1111C3.8827 16.7822 4 16.3956 4 16C4 15.4696 3.78929 14.9609 3.41421 14.5858C3.03914 14.2107 2.53043 14 2 14ZM2 7C1.60444 7 1.21776 7.1173 0.888861 7.33706C0.559963 7.55682 0.303617 7.86918 0.152242 8.23463C0.000866562 8.60009 -0.0387401 9.00222 0.0384303 9.39018C0.115601 9.77814 0.306083 10.1345 0.585788 10.4142C0.865493 10.6939 1.22186 10.8844 1.60982 10.9616C1.99778 11.0387 2.39992 10.9991 2.76537 10.8478C3.13082 10.6964 3.44318 10.44 3.66294 10.1111C3.8827 9.78224 4 9.39556 4 9C4 8.46957 3.78929 7.96086 3.41421 7.58579C3.03914 7.21071 2.53043 7 2 7Z" fill="#3D485B"></path>
                     </svg>
                  </a>
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        <div class="flex w-10 h-10 mr-3 items-center justify-center bg-gray-400 bg-opacity-20 text-blue-500 rounded-xl">
                           <img src="trizzle-assets/logos/slack.svg" alt="" data-config-id="auto-img-3-2">
                        </div>
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-32-2">Slack</h5>
                           <p class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-33-2">Updated about 7 hours</p>
                        </div>
                     </div>
                     <svg width="4" height="18" viewbox="0 0 4 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-8-2">
                        <path d="M2 4C2.39556 4 2.78224 3.8827 3.11114 3.66294C3.44004 3.44318 3.69639 3.13082 3.84776 2.76537C3.99914 2.39992 4.03874 1.99778 3.96157 1.60982C3.8844 1.22186 3.69392 0.865492 3.41421 0.585787C3.13451 0.306082 2.77814 0.115601 2.39018 0.0384303C2.00222 -0.0387401 1.60009 0.000866562 1.23463 0.152242C0.869182 0.303617 0.556825 0.559962 0.337062 0.88886C0.117299 1.21776 1.07779e-06 1.60444 1.07779e-06 2C1.07779e-06 2.53043 0.210715 3.03914 0.585788 3.41421C0.960861 3.78929 1.46957 4 2 4ZM2 14C1.60444 14 1.21776 14.1173 0.888861 14.3371C0.559963 14.5568 0.303617 14.8692 0.152242 15.2346C0.000866562 15.6001 -0.0387401 16.0022 0.0384303 16.3902C0.115601 16.7781 0.306083 17.1345 0.585788 17.4142C0.865493 17.6939 1.22186 17.8844 1.60982 17.9616C1.99778 18.0387 2.39992 17.9991 2.76537 17.8478C3.13082 17.6964 3.44318 17.44 3.66294 17.1111C3.8827 16.7822 4 16.3956 4 16C4 15.4696 3.78929 14.9609 3.41421 14.5858C3.03914 14.2107 2.53043 14 2 14ZM2 7C1.60444 7 1.21776 7.1173 0.888861 7.33706C0.559963 7.55682 0.303617 7.86918 0.152242 8.23463C0.000866562 8.60009 -0.0387401 9.00222 0.0384303 9.39018C0.115601 9.77814 0.306083 10.1345 0.585788 10.4142C0.865493 10.6939 1.22186 10.8844 1.60982 10.9616C1.99778 11.0387 2.39992 10.9991 2.76537 10.8478C3.13082 10.6964 3.44318 10.44 3.66294 10.1111C3.8827 9.78224 4 9.39556 4 9C4 8.46957 3.78929 7.96086 3.41421 7.58579C3.03914 7.21071 2.53043 7 2 7Z" fill="#3D485B"></path>
                     </svg>
                  </a>
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        <div class="flex w-10 h-10 mr-3 items-center justify-center bg-gray-400 bg-opacity-20 text-blue-500 rounded-xl">
                           <img src="trizzle-assets/logos/github.svg" alt="" data-config-id="auto-img-4-2">
                        </div>
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-34-2">Github</h5>
                           <p class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-35-2">Updated about 7 hours</p>
                        </div>
                     </div>
                     <svg width="4" height="18" viewbox="0 0 4 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-9-2">
                        <path d="M2 4C2.39556 4 2.78224 3.8827 3.11114 3.66294C3.44004 3.44318 3.69639 3.13082 3.84776 2.76537C3.99914 2.39992 4.03874 1.99778 3.96157 1.60982C3.8844 1.22186 3.69392 0.865492 3.41421 0.585787C3.13451 0.306082 2.77814 0.115601 2.39018 0.0384303C2.00222 -0.0387401 1.60009 0.000866562 1.23463 0.152242C0.869182 0.303617 0.556825 0.559962 0.337062 0.88886C0.117299 1.21776 1.07779e-06 1.60444 1.07779e-06 2C1.07779e-06 2.53043 0.210715 3.03914 0.585788 3.41421C0.960861 3.78929 1.46957 4 2 4ZM2 14C1.60444 14 1.21776 14.1173 0.888861 14.3371C0.559963 14.5568 0.303617 14.8692 0.152242 15.2346C0.000866562 15.6001 -0.0387401 16.0022 0.0384303 16.3902C0.115601 16.7781 0.306083 17.1345 0.585788 17.4142C0.865493 17.6939 1.22186 17.8844 1.60982 17.9616C1.99778 18.0387 2.39992 17.9991 2.76537 17.8478C3.13082 17.6964 3.44318 17.44 3.66294 17.1111C3.8827 16.7822 4 16.3956 4 16C4 15.4696 3.78929 14.9609 3.41421 14.5858C3.03914 14.2107 2.53043 14 2 14ZM2 7C1.60444 7 1.21776 7.1173 0.888861 7.33706C0.559963 7.55682 0.303617 7.86918 0.152242 8.23463C0.000866562 8.60009 -0.0387401 9.00222 0.0384303 9.39018C0.115601 9.77814 0.306083 10.1345 0.585788 10.4142C0.865493 10.6939 1.22186 10.8844 1.60982 10.9616C1.99778 11.0387 2.39992 10.9991 2.76537 10.8478C3.13082 10.6964 3.44318 10.44 3.66294 10.1111C3.8827 9.78224 4 9.39556 4 9C4 8.46957 3.78929 7.96086 3.41421 7.58579C3.03914 7.21071 2.53043 7 2 7Z" fill="#3D485B"></path>
                     </svg>
                  </a>
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        <div class="flex w-10 h-10 mr-3 items-center justify-center bg-gray-400 bg-opacity-20 text-blue-500 rounded-xl">
                           <img src="trizzle-assets/logos/discord.svg" alt="" data-config-id="auto-img-5-2">
                        </div>
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-36-2">Discord</h5>
                           <p class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-37-2">Updated about 7 hours</p>
                        </div>
                     </div>
                     <svg width="4" height="18" viewbox="0 0 4 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-10-2">
                        <path d="M2 4C2.39556 4 2.78224 3.8827 3.11114 3.66294C3.44004 3.44318 3.69639 3.13082 3.84776 2.76537C3.99914 2.39992 4.03874 1.99778 3.96157 1.60982C3.8844 1.22186 3.69392 0.865492 3.41421 0.585787C3.13451 0.306082 2.77814 0.115601 2.39018 0.0384303C2.00222 -0.0387401 1.60009 0.000866562 1.23463 0.152242C0.869182 0.303617 0.556825 0.559962 0.337062 0.88886C0.117299 1.21776 1.07779e-06 1.60444 1.07779e-06 2C1.07779e-06 2.53043 0.210715 3.03914 0.585788 3.41421C0.960861 3.78929 1.46957 4 2 4ZM2 14C1.60444 14 1.21776 14.1173 0.888861 14.3371C0.559963 14.5568 0.303617 14.8692 0.152242 15.2346C0.000866562 15.6001 -0.0387401 16.0022 0.0384303 16.3902C0.115601 16.7781 0.306083 17.1345 0.585788 17.4142C0.865493 17.6939 1.22186 17.8844 1.60982 17.9616C1.99778 18.0387 2.39992 17.9991 2.76537 17.8478C3.13082 17.6964 3.44318 17.44 3.66294 17.1111C3.8827 16.7822 4 16.3956 4 16C4 15.4696 3.78929 14.9609 3.41421 14.5858C3.03914 14.2107 2.53043 14 2 14ZM2 7C1.60444 7 1.21776 7.1173 0.888861 7.33706C0.559963 7.55682 0.303617 7.86918 0.152242 8.23463C0.000866562 8.60009 -0.0387401 9.00222 0.0384303 9.39018C0.115601 9.77814 0.306083 10.1345 0.585788 10.4142C0.865493 10.6939 1.22186 10.8844 1.60982 10.9616C1.99778 11.0387 2.39992 10.9991 2.76537 10.8478C3.13082 10.6964 3.44318 10.44 3.66294 10.1111C3.8827 9.78224 4 9.39556 4 9C4 8.46957 3.78929 7.96086 3.41421 7.58579C3.03914 7.21071 2.53043 7 2 7Z" fill="#3D485B"></path>
                     </svg>
                  </a>
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        <div class="flex w-10 h-10 mr-3 items-center justify-center bg-gray-400 bg-opacity-20 text-blue-500 rounded-xl">
                           <img src="trizzle-assets/logos/spotify.svg" alt="" data-config-id="auto-img-6-2">
                        </div>
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-38-2">Spotify</h5>
                           <p class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-39-2">Updated about 7 hours</p>
                        </div>
                     </div>
                     <svg width="4" height="18" viewbox="0 0 4 18" fill="none" xmlns="http://www.w3.org/2000/svg" data-config-id="auto-svg-11-2">
                        <path d="M2 4C2.39556 4 2.78224 3.8827 3.11114 3.66294C3.44004 3.44318 3.69639 3.13082 3.84776 2.76537C3.99914 2.39992 4.03874 1.99778 3.96157 1.60982C3.8844 1.22186 3.69392 0.865492 3.41421 0.585787C3.13451 0.306082 2.77814 0.115601 2.39018 0.0384303C2.00222 -0.0387401 1.60009 0.000866562 1.23463 0.152242C0.869182 0.303617 0.556825 0.559962 0.337062 0.88886C0.117299 1.21776 1.07779e-06 1.60444 1.07779e-06 2C1.07779e-06 2.53043 0.210715 3.03914 0.585788 3.41421C0.960861 3.78929 1.46957 4 2 4ZM2 14C1.60444 14 1.21776 14.1173 0.888861 14.3371C0.559963 14.5568 0.303617 14.8692 0.152242 15.2346C0.000866562 15.6001 -0.0387401 16.0022 0.0384303 16.3902C0.115601 16.7781 0.306083 17.1345 0.585788 17.4142C0.865493 17.6939 1.22186 17.8844 1.60982 17.9616C1.99778 18.0387 2.39992 17.9991 2.76537 17.8478C3.13082 17.6964 3.44318 17.44 3.66294 17.1111C3.8827 16.7822 4 16.3956 4 16C4 15.4696 3.78929 14.9609 3.41421 14.5858C3.03914 14.2107 2.53043 14 2 14ZM2 7C1.60444 7 1.21776 7.1173 0.888861 7.33706C0.559963 7.55682 0.303617 7.86918 0.152242 8.23463C0.000866562 8.60009 -0.0387401 9.00222 0.0384303 9.39018C0.115601 9.77814 0.306083 10.1345 0.585788 10.4142C0.865493 10.6939 1.22186 10.8844 1.60982 10.9616C1.99778 11.0387 2.39992 10.9991 2.76537 10.8478C3.13082 10.6964 3.44318 10.44 3.66294 10.1111C3.8827 9.78224 4 9.39556 4 9C4 8.46957 3.78929 7.96086 3.41421 7.58579C3.03914 7.21071 2.53043 7 2 7Z" fill="#3D485B"></path>
                     </svg>
                  </a>
               </div>
            ...
            <div class="w-full lg:w-2/3 px-3">
               <div class="h-full p-6 bg-gray-500 rounded-xl">
                  <h4 class="text-lg text-gray-100 font-semibold mb-6" data-config-id="auto-txt-40-2">Latest Products</h4>
                     ...
                     <table class="w-full min-w-max">
                           ...
                           <tr class="text-left">
                              <th class="p-0">
                                 <div class="py-3 px-6 rounded-l-xl bg-gray-600">
                                    <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-41-2">ORDER REF</span>
                                 </div>
                              </th>
                              <th class="p-0">
                                 <div class="py-3 px-6 bg-gray-600">
                                    <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-42-2">CUSTOMER</span>
                                 </div>
                              </th>
                              <th class="p-0">
                                 <div class="py-3 px-6 bg-gray-600">
                                    <button class="inline-flex items-center text-xs text-gray-300 font-semibold">
                                       <span class="mr-2" data-config-id="auto-txt-43-2">DATE</span>
                              ...
                              <th class="p-0">
                                 <div class="py-3 px-5 rounded-r-xl bg-gray-600">
                                    <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-44-2">STATUS</span>
                                 </div>
                              </th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-45-2">CDD1049</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <div class="flex h-full items-center">
                                       <img class="w-8 h-8 mr-3 rounded-full object-cover" src="trizzle-assets/images/avatar-men-circle-border.png" alt="" data-config-id="auto-img-7-2">
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-46-2">John Doe</span>
                                    </div>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <span class="text-sm text-gray-100 font-medium" data-config-id="auto-txt-47-2">July 06, 2025</span>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <div class="flex h-full items-center">
                                       ...
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-48-2">Pending</span>
                                    </div>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td class="p-0">
                                 <div class="h-16 p-6 rounded-l-xl bg-gray-600">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-49-2">CDD1049</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6 bg-gray-600">
                                    <div class="flex h-full items-center">
                                       <img class="w-8 h-8 mr-3 rounded-full object-cover" src="trizzle-assets/images/avatar-men-circle-border.png" alt="" data-config-id="auto-img-8-2">
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-50-2">John Doe</span>
                                    </div>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6 bg-gray-600">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-51-2">July 06, 2025</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="flex h-16 p-6 items-center rounded-r-xl bg-gray-600">
                                    ...
                                    <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-52-2">Delivered</span>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-53-2">CDD1049</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <div class="flex h-full items-center">
                                       <img class="w-8 h-8 mr-3 rounded-full object-cover" src="trizzle-assets/images/avatar-men-circle-border.png" alt="" data-config-id="auto-img-9-2">
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-54-2">John Doe</span>
                                    </div>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <span class="text-sm text-gray-100 font-medium" data-config-id="auto-txt-55-2">July 06, 2025</span>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <div class="flex h-full items-center">
                                       <span class="inline-block w-2 h-2 mr-1 bg-yellow-500 rounded-full"></span>
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-56-2">Pending</span>
                                    </div>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td class="p-0">
                                 <div class="h-16 p-6 rounded-l-xl bg-gray-600">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-57-2">CDD1049</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6 bg-gray-600">
                                    <div class="flex h-full items-center">
                                       <img class="w-8 h-8 mr-3 rounded-full object-cover" src="trizzle-assets/images/avatar-men-circle-border.png" alt="" data-config-id="auto-img-10-2">
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-58-2">John Doe</span>
                                    </div>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6 bg-gray-600">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-59-2">July 06, 2025</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="flex h-16 p-6 items-center rounded-r-xl bg-gray-600">
                                    <span class="inline-block w-2 h-2 mr-1 bg-red-500 rounded-full"></span>
                                    <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-60-2">Refunded</span>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-61-2">CDD1049</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <div class="flex h-full items-center">
                                       <img class="w-8 h-8 mr-3 rounded-full object-cover" src="trizzle-assets/images/avatar-men-circle-border.png" alt="" data-config-id="auto-img-11-2">
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-62-2">John Doe</span>
                                    </div>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <span class="text-sm text-gray-100 font-medium" data-config-id="auto-txt-63-2">July 06, 2025</span>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6">
                                    <div class="flex h-full items-center">
                                       <span class="inline-block w-2 h-2 mr-1 bg-yellow-500 rounded-full"></span>
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-64-2">Pending</span>
                                    </div>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td class="p-0">
                                 <div class="h-16 p-6 rounded-l-xl bg-gray-600">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-65-2">CDD1049</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6 bg-gray-600">
                                    <div class="flex h-full items-center">
                                       <img class="w-8 h-8 mr-3 rounded-full object-cover" src="trizzle-assets/images/avatar-men-circle-border.png" alt="" data-config-id="auto-img-12-2">
                                       <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-66-2">John Doe</span>
                                    </div>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="h-16 p-6 bg-gray-600">
                                    <h5 class="text-sm font-medium text-gray-100" data-config-id="auto-txt-67-2">July 06, 2025</h5>
                                 </div>
                              </td>
                              <td class="p-0">
                                 <div class="flex h-16 p-6 items-center rounded-r-xl bg-gray-600">
                                    <span class="inline-block w-2 h-2 mr-1 bg-red-500 rounded-full"></span>
                                    <span class="text-sm font-medium text-gray-100" data-config-id="auto-txt-68-2">Refunded</span>
                                 </div>
                              </td>
                           </tr>
                        </tbody>
...
<script>
   const projectFiles = ["index.html"];
</script>
<script src="https://shuffle.dev/static/build/js/anchors.c54bcdd7.js" defer=""></script>
<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
<script src="https://shuffle.dev/vendor/tailwind-trizzle/js/charts-demo.js"></script>