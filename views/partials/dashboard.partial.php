               ...
               <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-1-2">Dokumente Total</span>
                        <h4 class="text-2xl leading-8 text-gray-100 font-semibold mb-4" data-config-id="auto-txt-2-2">12</h4>
                     </div>
                  </div>
               </div>
               <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-5-2">Kunden Total</span>
                        <h4 class="text-2xl leading-8 text-gray-100 font-semibold mb-4" data-config-id="auto-txt-6-2">7</h4>
                     </div>
                  </div>
               </div>
               <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                  <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl">
                     <div class="max-w-xs mx-auto text-center">
                        ...
                        <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-9-2">Erledigt</span>
         ...
         <div class="flex flex-wrap -mx-3">
            <div class="w-full lg:w-1/3 px-3 mb-6 lg:mb-0">
               <div class="h-full py-6 px-4 sm:px-6 bg-gray-500 rounded-xl">
                  <h4 class="text-lg text-gray-100 font-semibold mb-6" data-config-id="auto-txt-27-2">Schnellzugriff</h4>
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        ...
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-28-2">Jira</h5>
                        </div>
                     </div>
                  ...
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        ...
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-30-2">Confluence</h5>
                        </div>
                     </div>
                  ...
                  <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150" href="#">
                     <div class="flex items-center pr-2">
                        ...
                        <div>
                           <h5 class="text-sm text-gray-100 leading-5 font-medium mb-1" data-config-id="auto-txt-32-2">Actricity</h5>
                        </div>
                     </div>
            ...
            <div class="w-full lg:w-2/3 px-3">
               <div class="h-full p-7 bg-gray-500 rounded-xl">
                  <h4 class="text-lg text-gray-100 font-semibold mb-6" data-config-id="auto-txt-40-2">Dokumentenübersicht</h4>
                           ...
                           <tr class="text-left">
                              <th class="p-0">
                                 <div class="py-3 px-6 rounded-l-xl bg-gray-600">
                                    <span class="text-xs text-gray-300 font-semibold" data-config-id="auto-txt-42-2">KUNDE</span>
                                 </div>
                              </th>
                              <th class="p-0">
                                 <div class="py-3 px-6 bg-gray-600">
                                    <button class="inline-flex items-center text-xs text-gray-300 font-semibold">
                                       <span class="mr-2" data-config-id="auto-txt-43-2">DATUM</span>
